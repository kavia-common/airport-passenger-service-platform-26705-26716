package com.example.airportfacilityservice;
...
@RestController
@Tag(name = "Hello Controller", description = "Basic endpoints for airport_facility_service")
public class HelloController {

    @GetMapping("/")
    @Operation(summary = "Welcome endpoint", description = "Returns a welcome message")
    public String hello() {
        return "Hello, Spring Boot! Welcome to airport_facility_service";
    }
    ...
    @GetMapping("/health")
    @Operation(summary = "Health check", description = "Legacy health check endpoint (prefer /actuator/health)")
    ...
    public String info() {
        return "Spring Boot Application: airport_facility_service";
    }
}
